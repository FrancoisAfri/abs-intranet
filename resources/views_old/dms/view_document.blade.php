        ...
        <div class="col-md-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-users"></i> File</h3>
					...
					<div class="box-body no-padding no-margin">
						<div class="overflow-X:auto; overflow-Y:auto;">
							<table class="table table-striped" >
								<tr><th colspan="3">{{$file->document_name}}</th></tr>
									<tr>
										<td colspan="3">
										
											<iframe frameborder="0" scrolling="yes" style="border:0px" 
												src="{{ $document}}#toolbar=0&navpanes=0&scrollbar=0" width="1000" height="800">
											</iframe>
