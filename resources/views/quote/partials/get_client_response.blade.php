<div id="client-response-modal" class="modal modal-default fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" name="client-response-form" enctype="multipart/form-data">
			{{ csrf_field() }}
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="client-response" class="btn btn-primary"><i class="fa fa-upload"></i> Save</button>
                </div>
            </form>
        </div>
        <!-- /.modal-content -->
