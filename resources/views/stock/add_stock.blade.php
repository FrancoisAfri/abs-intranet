...
<!--                                 <td><button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-contact-warning-modal"><i class="fa fa-trash"></i> Delete</button></td>-->
                    ...
                    <div class="box-footer">
                     ...
                     <button type="button" id="safe_module" class="btn btn-warning pull-right" data-toggle="modal" data-target="#add-jobparts-modal">Add new Stock</button>
                    </div>
             </div>
        </div>
...
<script>
       function postData(id , data ){   
        ...
        $('#back_button').click(function () {
                location.href = '/jobcards/viewcard';
            });
        $(function () {
            var moduleId;
