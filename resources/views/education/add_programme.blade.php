                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" value="PROG{{ !empty($programmeCode->id) ? $programmeCode->id : 1}}" placeholder="Enter Programme Code..." disabled>
                                </div>
								<!-- /.form-group -->
                                ...
                                <div class="form-group{{ $errors->has('budget_expenditure') ? ' has-error' : '' }}">
                                    ...
                                    <input type="number" class="form-control" id="budget_expenditure" name="budget_expenditure" value="{{ old('budget_expenditure') }}" placeholder="Enter Budget Expenditure...">
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group{{ $errors->has('budget_income') ? ' has-error' : '' }}">
                                    <label for="budget_income" class="control-label">Budget Income</label>
                                    <input type="text" class="form-control" id="budget_income" name="budget_income" value="{{ old('budget_income') }}" placeholder="Enter Budget Income...">
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('sponsor') ? ' has-error' : '' }}">
                                    <label for="sponsor" class="control-label">External Sponsor</label>
                                    <input type="text" class="form-control" id="sponsor" name="sponsor" value="{{ old('sponsor') }}" placeholder="Enter Sponsor...">
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group{{ $errors->has('sponsorship_amount') ? ' has-error' : '' }}">
                                    ...
                                    <input type="number" class="form-control" id="sponsorship_amount" name="sponsorship_amount" value="{{ old('sponsorship_amount') }}" placeholder="Enter the Value of Sponsorship...">
                                </div>
                                <!-- /.form-group -->
                                ...
                                <div class="form-group{{ $errors->has('contract_amount') ? ' has-error' : '' }}">
                                    ...
                                    <input type="number" class="form-control" id="contract_amount" name="contract_amount" value="{{ old('contract_amount') }}" placeholder="Enter the Contract Value...">
                                </div>
                                <!-- /.form-group -->
