...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            <form class="form-horizontal" method="POST" action="/users/get_users_date_report_print">
				...
				<input type="hidden" name="division_level_2" value="{{!empty($division_level_2) ? $division_level_2 : 0}}">
				<input type="hidden" name="division_level_1" value="{{!empty($division_level_1) ? $division_level_1 : 0}}">
		...
		$(function () {
			$('#example2').DataTable({
				...
				buttons: [
					{
						extend: 'excelHtml5',
						title: 'Employee Report Dates Report'
					},
					{
						extend: 'csvHtml5',
						title: 'Employee Report Dates Report'
