    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <h3 class="box-title">Loan Search</h3>
                <p id="box-subtitle">Search Criteria</p>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form name="loan-application-form" class="form-horizontal" method="POST" action="/loan/admin-search">
                {{ csrf_field() }}
                <div class="box-body">
                    @if (count($errors) > 0)
                    ...
                    <div class="form-group {{ $errors->has('type') ? ' has-error' : '' }}">
                        <label for="type" class="col-sm-2 control-label">Application Types</label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                <div class="input-group-addon">
                                     <i class="fa fa-black-tie"></i>
                                </div>
                                <select id="type" name="type" onChange= "changetextbox();" class="form-control">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <select class="form-control select2 " style="width: 100%;"
										id="status" name="status" data-select2-id="1" tabindex="-1"
										aria-hidden="true">
