...
<head>
    ...
    <title>{{ $company_name }} - {{$type}} Application</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    Hi {{ $first_name }},<br><br>
                                                    We would like to inform you that there is a new {{ $type }} application that requires your attention. Please Log on to the system and attend to it.<a href="{{ $dashboard_url }}">Click Here</a>.
                                                </td>
                                            </tr>
                                            <tr>
