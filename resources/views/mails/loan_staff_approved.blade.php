...
<head>
    ...
    <title>{{ $company_name }} - {{$type}} Application Feedback</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    Hi {{ $first_name }},<br><br>
                                                    We are please to tell you that your {{ $type }} application have been approved.
													Please Log on to the system to <a href="{{ $dashboard_url }}">Track Your Application</a>.
													Relevant Stakeholder will contact you to complete the process.
                                                </td>
                                            </tr>
                                            <tr>
