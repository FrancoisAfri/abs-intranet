...
<head>
    ...
    <title>{{ $company_name }} - Leave Application Reminder Email</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    ...
                                                    You receiving this email because you did not clock in on the {{ $date }} ,
                                                    <p>
                                                     you therefor are required to apply for leave for that particular day.
                                                    <br>
                                                    <br>

                                                        Please can you attend to the matter as soon as possible.
                                                    <br>
                                                    <br>
                                                    If You have already applied, please disregard this email
                                                    <br>
                                                    <br>
