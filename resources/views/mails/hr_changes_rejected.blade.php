...
<head>
    ...
    <title>{{ $company_name }} - HR Changes Rejected</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    Hi {{ $first_name }},<br><br>
                                                    We would like to inform you that, changes you made on your HR profile have been rejected by HR. Rejection reason: {{$description}}, please  <a href="{{ $dashboard_url }}">Click Here</a> to go to your dashboard.
                                                </td>
                                            </tr>
                                            <tr>
