...
<head>
    ...
    <title>{{ $company_name }} - HR Changes Approval</title>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    Hi {{ $first_name }},<br><br>
                                                    We would like to inform you that, new HR changes that are awaiting your approval on {{ $company_name }}, please  <a href="{{ $dashboard_url }}">Click Here</a> to approve changes.
                                                </td>
                                            </tr>
                                            <tr>
