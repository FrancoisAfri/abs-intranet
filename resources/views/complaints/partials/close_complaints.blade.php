<div id="close-complaints-modal" class="modal modal-default fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="close-complaints-form">
                {{ csrf_field() }}
                {{ method_field('PATCH') }}
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Close Complaints / Compliments</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="close_complaint" class="btn btn-primary">Save</button>
