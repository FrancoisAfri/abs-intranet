                        ...
                        <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{ $company->phone_number }}" data-inputmask='"mask": "(999) 999-9999"' placeholder="Phone Number" data-mask>
                                </div>
                            </div>
                        </div>
