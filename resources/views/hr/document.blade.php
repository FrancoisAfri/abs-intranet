                              ...
                              @foreach ($doc_type as $type)
                               <tr>
                                    <td style=" text-align: center;" nowrap>
                                        <button type="button" id="edit_compan" class="btn btn-primary  btn-xs" data-toggle="modal" data-target="#" data-id="{{ $type->id }}" data-name="{{ $type->name }}" data-description="{{$type->description}}" ><i class="fa fa-pencil-square-o"></i> Edit</button>
                                            <a  id="edit_compan" class="btn btn-primary  btn-xs"   data-id="{{ $type->id }}" data-name="{{ $type->name }}" data-description="{{$type->description}}" ><i class="fa fa-eye"></i> Category</a>
                                    </td>
                                    <td>{{ $type->name }}</td>
...
*/
            ...
            $('#add-category-modal').on('show.bs.modal', function (e) {
                ...
                var department = btnEdit.data('department');
       ...
       $('#update_company-modal').on('click', function () {
                var strUrl = '/hr/company_edit/' + updatecompanyID;
