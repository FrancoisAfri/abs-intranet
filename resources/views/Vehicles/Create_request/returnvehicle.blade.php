    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form name="leave-application-form" class="form-horizontal" method="POST" action="/vehicle_management/{{ $returnVeh->id }}/confirmbooking"
...
@section('page_script')
    ...
    <script type="text/javascript">
        ...
        $('#add_document').on('click', function () {
            ...
            var redirectUrl = '/vehicle_management/collect/{{ $returnVeh->id}}';
