        ...
        <div class="col-md-12">
            ...
            <!-- /.box-header -->
                        ...
                        @if (count($jobcardMaintance) > 0)
                            @foreach ($jobcardMaintance as $card)
                                <tr id="categories-list">
                                    <td nowrap>
                                        <button vehice="button" id="edit_compan" class="btn btn-warning  btn-xs" data-toggle="modal" data-target="#edit-package-modal" data-id="{{ $card->id }}" data-name="{{ $card->name }}" data-description="{{$card->description}}" ><i class="fa fa-pencil-square-o"></i> Edit</button>
                                    </td>
                                    <td>{{ (!empty( $card->name)) ?  $card->name : ''}} </td>
                                    <td>{{ (!empty( $card->description)) ?  $card->description : ''}} </td>
                                    <td>
                                        <!--   leave here  -->
                ...
                <div class="box-footer">
                    <button type="button" id="cat_module" class="btn btn-warning pull-right" data-toggle="modal" data-target="#add-promotion-modal">Add New Job Card</button>
                </div>
            </div>
        </div>
