                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="vehicle_reg" class="form-control pull-left"
                                               name="vehicle_reg"
                                               value="{{ $details->vehicle_reg }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="capturer_id" class="form-control pull-left"
                                               name="capturer_id"
                                               value="{{  $details->capturer_id }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="driver_id" class="form-control pull-left"
                                               name="driver_id"
                                               value="{{  $details->firstname . ' ' . $details->surname }}"
                                               readonly>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="require_datetime"
                                               ...
                                               value="{{ date("F j, Y, g:i a", $details->require_datetime)  }}"
                                               readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="require_datetime"
                                               class="form-control pull-left" name="require_datetime"
                                               value="{{ date("F j, Y, g:i a", $details->return_datetime)  }}"
                                               readonly>
                                    </div>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="collect_timestamp"
                                               ...
                                               value="{{ $usageType[$details->usage_type] }}"
                                               readonly>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="collect_timestamp"
                                               class="form-control pull-left" name="collect_timestamp"
                                               value="{{ $bookingStatus[$details->status] }}"
                                               readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="collect_timestamp"
                                               class="form-control pull-left" name="collect_timestamp"
                                               value="{{ !empty($details->collect_timestamp ) ?  date("F j, Y, g:i a", $details->collect_timestamp)  : ''}}"
                                               readonly>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="start_mileage_id" class="form-control pull-left"
                                               ...
                                               value="{{  $details->start_mileage_id }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
