               ...
               <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group{{ $errors->has('image_type') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <label class="radio-inline" style="padding-left: 0px;"><input type="radio" id="rdo_single" name="image_type" value="1" checked> Single  </label>
                                    <label class="radio-inline"><input type="radio" id="rdo_zip" name="image_type" value="2"> Bulk </label>
                                </div>
                            </div>
                   ...
                   <div class="form-group Single-field">
                     ...
                     <div class="form-group zip-field">
                        ...
                        <div class="col-sm-8">
                                ...
                                <textarea class="form-control" id="description" name="description" placeholder="Please make sure you zip the files you wish to upload and then upload the zip file. The files in zip file will then be uploaded..." rows="3" readonly="">{{ old('description') }}</textarea>
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="file" id="images" name="images"  class="file file-loading" data-allowed-file-extensions='["jpg", "jpeg", "png"]' data-show-upload="false">
                        </div>
                    </div>
                    ...
                    <button type="button" id="add-vehicle_image" class="btn btn-warning"><i class="fa fa-cloud-upload"></i> Save</button>
                </div>
             </form>
            </div>
         </div>
