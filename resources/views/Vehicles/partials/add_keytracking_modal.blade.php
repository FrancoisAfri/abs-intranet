                ...
                <div class="modal-body">
                    ...
                    <div id="success-alert"></div>
                     ...
                     <div class="form-group Single-field">
                        <label for="path" class="col-sm-3 control-label">Key Number </label>
                             <div class="col-sm-8">
                            <input type="text" class="form-control" id="key_number" name="key_number" value="" placeholder="Enter Key Number" required>
                             </div>
                     </div>
                     ...
                     <div class="form-group notes-field{{ $errors->has('description') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-8">
                         ...
                         <div class="form-group{{ $errors->has('key') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <label class="radio-inline" style="padding-left: 0px;"><input type="radio" id="rdo_user" name="key" value="1" checked> Employee   </label>
                                    <label class="radio-inline"><input type="radio" id="rdo_safe" name="key" value="2"> Safe </label>
                                </div>
                    ...
                    <div class="form-group safe-field">
                      <label for="safe_controller" class="col-sm-3 control-label">Safe Controller</label>
                        <div class="col-sm-8">
                                <select class="form-control select2" style="width: 100%;" id="safe_controller" name="safe_controller">
                   ...
                   <div class="form-group ">
                        <label for="path" class="col-sm-3 control-label">Date Issued </label>
                             <div class="col-sm-8">
                             <input type="text" class="form-control" id="date_issued" name="date_issued" value="{{ old('date_issued') }}" placeholder="Select  issue date ...">
                        </div>
                    </div>
                     ...
                     <div class="form-group ">
                        <label for="path" class="col-sm-3 control-label">Captured By  </label>
                             <div class="col-sm-8">
                             <input type="text" class="form-control" id="employee" name="employee" value="{{ old('employee') }}" placeholder="Select  User ..." readonly="">
                        </div>
                    </div>
                    ...
                    <button type="button" id="add-key" class="btn btn-warning"><i class="fa fa-cloud-upload"></i> Save</button>
                </div>
             </form>
            </div>
         </div>
