            ...
            <form class="form-horizontal" method="POST" name="edit-image-form">
               ...
               <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="path" class="col-sm-3 control-label">Description</label>
                             <div class="col-sm-9">
                            <input type="text" class="form-control" id="description" name="description" value="{{ $vehicle_maintenance->image }}" placeholder="Enter Description" required>
                        </div>
                     </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="edit_image" class="btn btn-primary"><i class="fa fa-floppy-o"></i> Save</button>
                </div>
            </form>
            </div>
         </div>
