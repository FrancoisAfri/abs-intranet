            ...
            <form class="form-horizontal" method="POST" name="edit-module-form">
               ...
               <div class="modal-header">
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <h4 class="modal-title">Add new Fleet Filling Station damage categories </h4>
                </div>
                <div class="modal-body">
                    ...
                    <button type="button" id="add-filling-station" class="btn btn-warning"><i class="fa fa-cloud-upload"></i> Save</button>
                </div>
             </form>
            </div>
         </div>
