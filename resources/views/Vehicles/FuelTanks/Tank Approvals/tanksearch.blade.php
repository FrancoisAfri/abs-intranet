        ...
        <div class="col-md-12">
            ...
            <!--                                    <input type="text" class="form-control pull-right" id="reservation">-->
                            ...
                            <div class="form-group{{ $errors->has('application_type') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <label class="radio-inline" style="padding-left: 0px;"><input type="radio" id="rdo_levTkn" name="application_type" value="1" checked> Search </label>
                                    <label class="radio-inline"><input type="radio" id="rdo_bal" name="application_type" value="2"> Tank Fuel Approval</label>
                                    <label class="radio-inline"><input type="radio" id="rdo_po" name="application_type" value="3">   Other  </label>
                                </div>
                            </div>
                    ...
                    <!-- <div class="box-footer">
                     ...
                     <div class="box-footer">
                       ...
                       <button type="submit" id="gen-report" name="gen-report" class="btn btn-default pull-right"><i class="fa fa-search"></i> Search </button>
                    </div>
                    <!-- /.box-footer -->
                 </div>
                </form>
