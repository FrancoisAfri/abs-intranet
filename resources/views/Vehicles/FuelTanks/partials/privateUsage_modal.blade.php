            ...
            <form class="form-horizontal" method="POST" name="add-private-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="documents_date" name="documents_date" value=""
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="registration_number" name="registration_number" value=""
                    ...
                    <div class="form-group safe-field">
                        ...
                        <div class="col-sm-8">
                            <select class="form-control select2" style="width: 100%;" id="person_responsible" name="person_responsible">
                                <option value="0">*** Select a Safe ***</option>
                                @foreach($employees as $employee)
                                    <option value="{{ $employee->id }}"> {{ !empty($employee->first_name . ' ' . $employee->surname) ? $employee->first_name . ' ' . $employee->surname : ''}}</option>
                                @endforeach
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="add_privateUse" class="btn btn-warning"><i class="fa fa-cloud-upload"></i> Save
                    </button>
                </div>
            </form>
        </div>
