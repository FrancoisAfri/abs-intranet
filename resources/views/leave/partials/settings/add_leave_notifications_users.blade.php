<div id="add-leave-notification-modal" class="modal modal-default fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" method="POST" name="add-leave-notification-form">
                {{ csrf_field() }}
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="add-leave-users" class="btn btn-warning"><i
