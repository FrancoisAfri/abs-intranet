    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <form name="leave-application-form" class="form-horizontal" method="POST" action="/leave/bulk-leave-application">
                    {{ csrf_field() }}
                    ...
                    <div class="box-body" id="view_users">
						...
						<div class="col-xs-4">
                                <div class="form-group from-field {{ $errors->has('hours') ? ' has-error' : '' }}">
                                    <label for="hours" class="col-sm-6 control-label">Hour(s)</label>
                                    <div class="col-sm-">
                                        <div class="input-group">
                                            <div class="input-group-addon">
