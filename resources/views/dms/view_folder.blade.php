		...
		<div class="col-ms-9">
            <div class="box box-warning">
                ...
                <div class="box-body">
						...
						<table class="table table-bordered">
							...
							@if (count($files) > 0)
								@foreach ($files as $file)
									<tr>
										<td style="text-align: center"><a href="{{ '/dms/folder/view/' . $file->id}}" class="product-title">Manage</a></td>
										<td>{{ (!empty($file->folder_name)) ?  $file->folder_name : ''}} </td>
                    ...
                    <!-- /.box-body -->
                    <div class="box-footer">
                        <button type="button" class="btn btn-default pull-left" id="back_button"><i class="fa fa-arrow-up"></i> {{$folder->folder_name}}</button>
                        <button type="button" id="cat_module" class="btn btn-warning pull-right" data-toggle="modal"
                                data-target="#add-folder-modal">Add New File
                        </button>
                    </div>
                </div>
            </div>
