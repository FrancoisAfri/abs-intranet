...
<!--                {{ method_field('PATCH') }}-->
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="estimated_hours" name="estimated_hours" value=""
                    ...
                    <div class="form-group notes-field{{ $errors->has('description') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group">
                                ...
                                <textarea class="form-control" id="inspection_info" name="inspection_info" placeholder="Enter a inspection Info" rows="2">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="form-group supDoc-field{{ $errors->has('documents') ? ' has-error' : '' }}">
