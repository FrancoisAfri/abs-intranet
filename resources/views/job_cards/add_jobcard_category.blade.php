                            ...
                            @if (count($parts) > 0)
                              @foreach ($parts as $jobparts)
                               ...
                               <td nowrap>
                                 ...
                                 <td><button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-partscatergory-warning-modal" data-id="{{ $jobparts->id }}"><i class="fa fa-trash"></i> Delete</button></td>
                                </tr>
                                   @endforeach
                               @else
                               <tr id="categories-list">
...
<!--                         <button type="button" class="btn btn-default pull-left" id="back_button">Back</button>-->
                     <button type="button" id="safe_module" class="btn btn-warning pull-right" data-toggle="modal" data-target="#add-partscatagory-modal">Add new parts catagory </button>
                    </div>
             </div>
        </div>
