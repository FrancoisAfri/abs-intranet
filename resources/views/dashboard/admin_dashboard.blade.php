...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="box box-danger same-height-widget">
            <div class="box-header with-border">
                ...
                <h3 class="box-title">Category-Product(s)</h3>
                ...
                <div class="table-responsive">
                    <table class="table no-margin">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>   <button class="accordion"><i class="material-icons">add_circle</i>{{ (!empty($productcategory->name)) ?  $productcategory->name : ''}}</button>
                                    <div class="panel">
                                        <p align="right">{{ (!empty($productcategory->ProductCategory)) ?  $productcategory->ProductCategory : ''}}</p>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
    ...
    <div class="col-md-6">
        ...
        <div class="box box-danger same-height-widget">
            <div class="box-header with-border">
                <i class="fa fa-product-hunt"></i>
                <h3 class="box-title">Package-Product(s)</h3>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                    </button>
                    <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
