        ...
        <div class="modal-content">
            <form class="form-horizontal" name="edit-perk-form" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">View/Edit Perk</h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="description" name="description" placeholder="Enter The Perk's Description" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
