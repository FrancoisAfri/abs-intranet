    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-success">
                <form class="form-horizontal" method="POST" action="/cms/updatenews">
                    {{ csrf_field() }}
                    <div class="box-header with-border">
                        <h3 class="box-title">New news Page for - {{ !empty($Cmsnews->name) ? $Cmsnews->name : ''}}</h3>
                    ...
                    <div class="box-body">
                        <textarea id="send_invoice_message" name="summary" rows="10" cols="80"></textarea>
