...
class CreateVehicleConfigTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('vehicle_configuration', function (Blueprint $table) {
            ...
            $table->smallInteger('fuel_auto_approval')->nullable()->default(0);
            ...
            $table->integer('permit_days')->nullable()->default(0);
            $table->string('currency')->nullable()->default('rand');
            ...
            $table->integer('service_days')->nullable()->default(0);
            $table->integer('service_km')->nullable()->default(0);
            $table->integer('service_overdue_days')->nullable()->default(0);
            $table->integer('service_overdue_km')->nullable()->default(0);
            $table->integer('no_bookings_days')->nullable()->default(0);
            $table->integer('no_bookings_km')->nullable()->default(0);
            $table->smallInteger('no_bookings_minor')->nullable()->default(0);
            $table->smallInteger('no_bookings_major')->nullable()->default(0);
            $table->smallInteger('no_bookings_critical')->nullable()->default(0);
            $table->timestamps();
        });
    }
