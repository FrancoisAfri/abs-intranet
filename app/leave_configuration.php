...
class leave_configuration extends Model
{
    ...
    protected $fillable = ['allow_annualLeave_credit',
        'allow_sickLeave_credit', 'show_non_employees_in_leave_Module', 'require_managers_approval',
        'all_managers_to_approve', 'require_department_head_approval', 'require_hr_approval',
        'require_payroll_approval', 'limit_administration_to_assigned_divisions', 'number_of_days_until_escalation',
        'document_compulsory_on_Study_leave_application', 'document_compulsory_when_two_sick_leave_8_weeks',
        'notify_hr_with_application', 'preferred_communication_method',
		...
		'allow_unpaid_leave_when_annual_done'
    ];
}
