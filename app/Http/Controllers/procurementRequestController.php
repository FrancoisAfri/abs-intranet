...
class procurementRequestController extends Controller
{
	...
	public function store(Request $request) {
        ...
        AuditReportsController::store('Procurement', 'Stock Request Created', 'Created by User', 0);
	...
	public function updateRequest(Request $request, ProcurementRequest $stock) {
        ...
        AuditReportsController::store('Procurement', 'Stock Request Updated', 'Updated by User', 0);
        return response()->json();
    }
	...
	public function requestResults(Request $request)
    {
        ...
        $data['active_rib'] = 'Search Request';
        $data['breadcrumb'] = [
            ['title' => 'Procurement', 'path' => 'stock/seach_request', 'icon' => 'fa fa-lock', 'active' => 0, 'is_module' => 1],
	...
	public function requestApprovals()
    {
        ...
        if ($rowcolumn > 0 || !empty($userAccess)) 
		{
            ...
            $data['breadcrumb'] = [
                ['title' => 'Procurement', 'path' => 'stock/request_approval', 'icon' => 'fa fa-lock', 'active' => 0, 'is_module' => 1],
