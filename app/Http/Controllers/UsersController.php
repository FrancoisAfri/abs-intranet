...
class UsersController extends Controller
{
    ...
    public function viewAssets($user)
    {
        ...
        $assets = AssetTransfers::getAssetByUser($user);

        $licences = LicencesAllocation::with('Licenses')
            ->where(
        ...
        $data['assets'] = $assets;
        $data['file_name'] = 'Assets and Subscriptions';
        $view = view('assets.reports.list_of_assets', $data)->render();
