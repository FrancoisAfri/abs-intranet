...
Route::group(['prefix' => 'assets', 'namespace' => 'Assets', 'middleware' => ['auth']], function () {
    ...
    Route::patch('update/{asset}', 'AssetManagementController@update')
        ->name('assets.update');
...
Route::group(['prefix' => 'employee', 'namespace' => 'Employee', 'middleware' => ['auth']], function () {
	...
	Route::get('clockin_report', 'EmployeeDashboardController@clockinReports')
        ->name('employee.clockin_report');
	Route::get('attendance-reports', 'EmployeeDashboardController@attendanceReports')
        ->name('attendance.report');
	Route::get('dashboard', 'EmployeeDashboardController@employeeDashboard')
...
Route::get('dms/file/{file}/delete', 'DMSFoldersController@destroyFile');
...
Route::post('dms/user/access_request', 'DMSGrantAccessController@userRequestAccess');
...
Route::patch('dms/edit_file_details/{file}', 'DMSFoldersController@edit');
Route::get('dms/request', 'DMSGrantAccessController@dmsRequest');
Route::post('dms/reject-request/{requests}', 'DMSGrantAccessController@rejectRequest');
Route::get('dms/approve-request/{requests}', 'DMSGrantAccessController@approveRequest');
Route::get('dms/folder_delete/{folder}', 'DMSRecyle@destroyFoler');
Route::get('dms/file_delete/{file}', 'DMSRecyle@destroyFile');
